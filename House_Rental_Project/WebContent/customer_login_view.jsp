<%@page import="nit.com.bo.CustomerLogin"%>
...
CustomerLogin cust = (CustomerLogin)obj;
//Owner ow = (Owner)obj;
  ...
  <div id="logo"><img src="image/logo2.png" width="100%" height="140px" /></div>
     ...
     <div id="container1" style="margin-right:0px; margin-left:0px;">
        ...
        <li style="width:25%">Customer
           <ul>
               <a href="viewcustomerprofile?abc=<%=cust.getUsername()%>"> <li style="width: 100%">View_Profile</li></a>
               
                </ul>
        </li>
        
        <li style="width:25%">Search House
           <ul>
               <a href="house_search_form.jsp"> <li style="width: 100%">search by address</li></a>
           </ul>
        </li>               
        
           <li style="width:25%">Logout
           <ul>
                <a href="customerlogout"><li style="width: 100%">Logout</li></a>
           </ul>
        </li>    
     </ul>
	 </div> 			
